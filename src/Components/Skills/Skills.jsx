    ...
    >
      ...
      <div className="relative container mx-auto px-6 md:px-20">
        <div className="text-center mb-6">
          <h2
            className="relative inline-block text-3xl  md:text-4xl lg:text-5xl font-extrabold tracking-tight
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {skills.map((s) => (
            ...
            >
              {/* glow ring on hover */}
              <div
                className="pointer-events-none absolute inset-0 rounded-2xl opacity-0 blur-md transition-opacity duration-300 group-hover:opacity-100"
                style={{
                  background:
              ...
              <div className="relative flex items-start gap-4">
                ...
                <div className="w-full">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <span className="text-xs md:text-sm font-medium text-primary-200">
                      {s.percent}%
                    </span>
                  </div>
        ...
        <div className="mt-8 text-center text-xs text-white/50">
          * Percentages represent confidence & experience levels across
          projects.
        </div>
      </div>
    </section>
