...
import {
  faHtml5, faCss3Alt, faBootstrap, faJs, faReact, faSass, faGitAlt
} from "@fortawesome/free-brands-svg-icons";
import {
  faCode, faWind, faDiagramProject, faMobileAlt, faServer, faCloud, faBug
...
export default function Skills() {
  ...
  return (
    <section id="skills" className="relative scroll-mt-28 bg-black text-white py-16 md:py-20 overflow-hidden">
        <FloatingFAIcons
